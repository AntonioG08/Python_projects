...
"""Importamos RANDOM para meter valores al azar cuando se imprima el 'recibo' y la funcion DATETIME para ponerle una 
fecha al recibo de cuando se 'generó' """

"""En esta unidad usaremos la libreria tkinter para crear una interfaz de un restaurante
En este quinto ejercicio, la pestaña ya quedo diseñada en su totalidad. Ahora haremos que los botones funcionen
realmente - CONTINUACION (AGREGAMOS MAS FUNCIONALIDAD) """
