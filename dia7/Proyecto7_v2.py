from os import *
""" Proyecto con el uso de clases, version 2 después de ver la solución del curso"""
...
class Cliente(Persona):
    def __init__(self, nombre2, apellido2, numero_cuenta, balance=0):
...
def crear_cliente():
    ...
    system('cls')
    usuario = Cliente(nombre, apellido, '5579_0990_1408_0107')
    return usuario
