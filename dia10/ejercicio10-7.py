...
while se_ejecuta:
    ...
    # Ahora no usaremos un color de fondo, usaremos una imagen de fondo
    """Tuvimos que aumentar el numero de pixels por movimiento, ya que cargar el fondo pesa mucho mas, y hace que cada 
    iteración tarde más, y por ende se percibe mas lento el movimiento"""
